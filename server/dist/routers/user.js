...
exports.userRouter = (0, trpc_1.router)({
    signup: trpc_1.publicProcedure
        ...
        try {
            ...
            const response = yield opts.ctx.db.User.create({
                name,
                email,
                password,
            });
    ...
    deleteAccount: trpc_1.publicProcedure.use(user_1.isLoggedIn).mutation((opts) => __awaiter(void 0, void 0, void 0, function* () {
        const userId = opts.ctx.userId;
        let response = yield opts.ctx.db.User.findByIdAndDelete(userId);
        return {
            completed: true,
        };
    })),
